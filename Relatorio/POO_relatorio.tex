...
%%%%%%%%%%%%%     Mediadas de Performance 30%    %%%%%%%%%%%%%%%%
	\section{Medidas de Performance}
		...
		\subsection{Performance das Estruturas}
			...
			%\vspace{20pt}
			Este gráfico compara a diferença de tempo da povoação, e execução de duas das travessias mais pesadas, comparando a utilização de TreeMap vs HashMap.
			\includegraphics[width=\textwidth]{test_map.png}
			Este gráfico salienta a diferença de tempo de execução entre a utilização do Vector e do ArrayList na povuação das estruturas, e posteriormente na querie de duplicação de linhas.
