...
%%%%%%%%%%%%%     Mediadas de Performance 30%    %%%%%%%%%%%%%%%%
	...
	\section{Medidas de Performance}
		...
		\subsection{Performance das Estruturas}
			...
			O seguinte gráfico compara a utilização de TreeSet vs HashSet, na execução de duas queries, a que calcula as linhas duplicadas, e a que faz a listagem dos autores que publicam em todos os anos do intervalo.
